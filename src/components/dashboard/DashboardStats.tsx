  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
      <Card className="glass-card p-6 rounded-xl">
        ...
        <div className="text-3xl font-bold">{agent.totalValue}</div>
        <div className="flex items-center text-green-400 text-sm mt-2">
          <span className="mr-1">{agent.monthChange}</span>
      ...
      <Card className="glass-card p-6 rounded-xl">
        ...
        <div className="text-3xl font-bold">{agent.activeVaults}</div>
      ...
      <Card className="glass-card p-6 rounded-xl">
        ...
        <div className="text-3xl font-bold text-green-400">{agent.returns}</div>
        <div className="flex items-center text-white/60 text-sm mt-2">
      ...
      <Card className="glass-card p-6 rounded-xl">
        ...
        <div className="text-3xl font-bold">{agent.nextRewards}</div>
        <div className="flex items-center text-white/60 text-sm mt-2">
